---
thumbnail: "/writings/wpu-banner.webp"
title: "WPU Community"
description: "an indonesian discord programming community with 50,000 members. don't forget the semicolon;"
slug: "wpu-community"
category: "#community | #chatting"
date: "2025-02-03"
---

<>
  <p><img src="/writings/wpu-banner.webp" alt="Alt text" className="w-full h-[200px] sm:h-[280px] object-cover border border-foreground"/></p>
</>
...
- 🌟 Dapat mengirimkan Aplikasi atau Setup Desktop untuk di review dan di pamerkan oleh Lord Sandhika Galih melalui [Youtube/Playlist-Project-Kalian](https://www.youtube.com/playlist?list=PLFIM0718LjIWedIH884cQrsMKWWtB4wFL)
...
🎗️ **Link Discord WPU :** [discord.gg/wpu](https://discord.gg/wpu)

🌐 **Link Website Landing Page WPU** : [wpu.pow.kim](https://wpu.pow.kim)

💻 **Link Bellshade WPU** : [github/bellshade](https://github.com/bellshade)

📸 **Link Instagram WPU Community** : [instagram/wpu.community](https://www.instagram.com/wpu.community)

📸 **Link Instagram Pa Dhika** : [instagram/sandhikagalih](https://www.instagram.com/sandhikagalih)

🎥 **Link Youtube WPU** : [youtube/@sandhikagalihWPU](https://www.youtube.com/@sandhikagalihWPU)

📖 **Link WPU Course** : [wpucourse.id](https://wpucourse.id)
...
<div className="bg-suram py-[2px] w-full my-12"/>

## 💎 Tambahan

<>
  <p><img src="/writings/wpuanimestyle.png" alt="Alt text" className="w-80 h-auto"/></p>
</>
<>
  <p className="text-xs">source: Edqe14/Yuka</p>
</>