  ...
  return (
    <section className="w-full mx-auto">
      ...
      <p className="w-full text-zeta font-medium text-[16px] text-start mb-6">
        yea, just an ordinary npc and <CoffeeText>dumb in math</CoffeeText>, you
        can call me al sakha. i never imagined myself in the field of
        programming, but am now focusing on website development.{" "}
        <CoffeeText>unemployed</CoffeeText> and not in college. i hope to stick
